    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                # ValueError is how services signal *expected* validation
                # failures (bad amount, unknown expense id, etc.) — safe to
                # relay verbatim to the LLM/user. Anything else is an
                # unexpected internal error and gets a generic message so we
                # never leak stack traces, SQL, or file paths.
